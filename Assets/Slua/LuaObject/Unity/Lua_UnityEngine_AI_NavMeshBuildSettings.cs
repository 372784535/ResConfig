...
public class Lua_UnityEngine_AI_NavMeshBuildSettings : LuaObject {
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int get_minRegionArea(IntPtr l) {
		try {
			UnityEngine.AI.NavMeshBuildSettings self;
			checkValueType(l,1,out self);
			pushValue(l,true);
			pushValue(l,self.minRegionArea);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int set_minRegionArea(IntPtr l) {
		try {
			UnityEngine.AI.NavMeshBuildSettings self;
			checkValueType(l,1,out self);
			float v;
			checkType(l,2,out v);
			self.minRegionArea=v;
			setBack(l,self);
			pushValue(l,true);
			return 1;
		}
	...
	static public void reg(IntPtr l) {
		...
		addMember(l,"minRegionArea",get_minRegionArea,set_minRegionArea,true);
