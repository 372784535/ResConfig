        ...
        private static object ReadValue (Type inst_type, JsonReader reader)
        {
                ...
                reader.Token == JsonToken.Boolean)
            {
                ...
                if (custom_importers_table.ContainsKey(json_type) &&
                    custom_importers_table[json_type].ContainsKey(inst_type))
                {

                    ImporterFunc importer = custom_importers_table[json_type][inst_type];
                ...
                if (base_importers_table.ContainsKey(json_type) &&
                    base_importers_table[json_type].ContainsKey(inst_type))
                {

                    ImporterFunc importer = base_importers_table[json_type][inst_type];
